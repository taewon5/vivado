...
set_property -dict { PACKAGE_PIN B4    IOSTANDARD LVCMOS33 } [get_ports {data_out}]; #IO_L3P_T0_DQS_34 Sch=pio[46]
set_property -dict { PACKAGE_PIN A3    IOSTANDARD LVCMOS33 } [get_ports {load}]; #IO_L1N_T0_34 Sch=pio[47]
set_property -dict { PACKAGE_PIN A4    IOSTANDARD LVCMOS33 } [get_ports {clk_out}]; #IO_L1P_T0_34 Sch=pio[48]
